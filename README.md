...
- **Exibição de Tarefas**: Mostra todas as tarefas cadastradas de forma clara e organizada.
- **Remover Tarefas**: Oferece uma função para excluir tarefas específicas, com confirmação.
- **Interface Intuitiva**: Design simples e amigável, facilitando a interação com o usuário.
...
1.  **Clone o repositório do projeto:**
    ```bash
    git clone https://github.com/Lucas-Retanero/Lista-de-Tarefas-App.git
    ```
